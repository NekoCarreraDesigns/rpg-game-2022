...
class Player(Enemy):
    def __init__(self, pos, groups, obstacle_sprites, create_attack, destroy_attack, create_magic):
        ...
        self.image = pygame.image.load(
            './level graphics/graphics/test/player.png').convert_alpha()
        ...
        self.weapon_attack_sound = pygame.mixer.Sound(
            './level graphics/audio/sword.wav')
        self.weapon_attack.set_volume(0.4)
# player animations
...
# cooldown method for attacking and magic
